...
export function CalendarClient() {
  ...
  return (
    <div ref={calendarRef} className="lg:grid lg:grid-cols-[3fr_2fr] lg:gap-6 lg:items-start">
      ...
      <div className="space-y-4">
        ...
        {/* Day-of-week headers + calendar cells */}
        <div className="grid grid-cols-7 gap-1">
          ...
          {cells.map((day, i) => {
            ...
            let cellClass = "cal-day relative rounded-[2px] p-1 text-center cursor-pointer transition-all min-h-[40px] lg:min-h-[52px]";
